...
export const modalScreenCloseButtonScrollWithModalStyles =
  'relative z-[110] mb-[40px] inline-flex h-10 w-10 shrink-0 self-end items-center justify-center rounded-full border border-[#FDFEFF]/25 bg-[#FDFEFF]/5 text-xl leading-none text-[#FDFEFF] transition hover:bg-[#FDFEFF]/10 lg:fixed lg:mb-0 lg:self-auto lg:right-[160px] lg:top-[150px] lg:h-[50px] lg:w-[50px] lg:text-2xl';
