...
export const filterPanelTitleStyles =
  'mb-3 text-xs uppercase tracking-[0.12em] text-[#FDFEFF]/50';
export const filterPanelGroupStyles = 'flex flex-wrap gap-3 text-base font-normal text-[#FDFEFF]/85 lg:text-[18px]';
