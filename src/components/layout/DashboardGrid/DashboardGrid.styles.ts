...
export const dashboardGridRootStyles = [
  'grid w-full gap-[20px] items-stretch',
...
export const dashboardGridSecondRowLeftStyles = 'lg:col-span-2 h-full';
export const dashboardGridMiddleColumnStackStyles = 'flex h-full flex-col gap-[20px]';
