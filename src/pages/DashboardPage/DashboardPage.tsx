  ...
  return (
    <PageLayout>
      <section className="relative">
        ...
        newCheck={
          <Card
            title={<span className="uppercase lg:normal-case">Новая проверка</span>}
        ...
        tariff={
          <Card
            title={<span className="uppercase lg:normal-case">ТАРИФ</span>}
            aside="Что в тарифе ?"
            className="flex flex-1 flex-col"
            variant="dashboard"
          >
        ...
        telegram={
          ...
          >
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className={combineStyles('mb-5', designTokens.typography.cardTitle, 'text-center')}>
        ...
        recentRequests={
          <Card
            ...
            aside={
              <Link
                to="/history"
                className="hidden lg:inline-flex items-center gap-1 transition-colors hover:underline"
              >
              ...
              <div className="flex flex-col items-center">
                <div className="w-full lg:w-auto flex justify-center lg:justify-end">
                  <Button
                    variant="secondary"
                    size="sm"
                    className="w-full lg:w-auto min-h-14 border-white/25 px-6 py-4 text-[14px] lg:text-[20px] font-semibold"
                  >
